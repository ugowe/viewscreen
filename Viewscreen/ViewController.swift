...
class VideoCell: UICollectionViewCell {
    ...
    func setupViews() {
        ...
        addLayoutConstraints(format: "V:|-16-[v0]-8-[v1(44)]-16-[v2(1)]|", views: thumbnailImageView, userProfileImageView, separatorView)
        ...
        //top constraint
        addConstraint(NSLayoutConstraint(item: subtitleTextView, attribute: .top, relatedBy: .equal, toItem: titleLabel, attribute: NSLayoutAttribute.bottom, multiplier: 1, constant: 8))
